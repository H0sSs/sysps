...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // إعادة تعيين الجهاز باستخدام الدالة في functions.php
    $result = resetDevice($pdo, $device_id);

    if ($result['status'] === 'success') {
        echo json_encode(['status' => 'success', 'message' => 'تم إعادة تعيين الجهاز بنجاح.']);
    } else {
